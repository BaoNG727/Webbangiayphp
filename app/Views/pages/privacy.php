            ...
            <div class="prose prose-lg max-w-none">
                <section class="mb-8">
                    ...
                    <p class="text-gray-700 mb-4">
                        At Nike Shoe Store ("we," "us," or "our"), we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or make a purchase from us.
                    </p>
                </section>
                ...
                <section class="mb-8">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 mb-3">Types of Cookies We Use:</h3>
                    <ul class="list-disc list-inside text-gray-700 mb-4 ml-4">
                ...
                <section class="mb-8">
                    ...
                    <p class="text-gray-700 mb-4">
                        To exercise these rights, please contact us at privacy@nikestore.com.
                    </p>
                </section>
                ...
                <section class="mb-8">
                    ...
                    <p class="text-gray-700 mb-4">
                        Our website is not intended for children under 13. We do not knowingly collect personal information from children under 13. If we become aware that we have collected such information, we will take steps to delete it.
                    </p>
                </section>

                <section class="mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 mb-4">11. Third-Party Links</h2>
                    <p class="text-gray-700 mb-4">
                ...
                <section class="mb-8">
                    ...
                    <div class="bg-gray-50 p-6 rounded-lg">
                        <p class="text-gray-700">
                            <strong>Nike Shoe Store - Privacy Team</strong><br>
                            Email: privacy@nikestore.com<br>
                            Phone: 1-800-NIKE-STORE<br>
                            Address: 123 Athletic Way, Sports City, SC 12345<br>
                            <br>
                            <strong>Data Protection Officer:</strong><br>
                            Email: dpo@nikestore.com
                        </p>
                    </div>
                </section>
            </div>
